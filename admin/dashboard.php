...
<head>
    ...
    <title>Admin Dashboard | Sabana Beach Resort</title>
    <!-- Font Awesome CDN -->
...
<body>
    ...
    <section class="dashboard">
        <div class="content">
            ...
            <p>This is the admin dashboard where you can manage reservations and feedback.</p>
            ...
            <div class="dashboard-features">
                <div class="feature-card">
                    ...
                    <a href="all_reservations.php" class="btn">Go to Reservations</a>
                </div>
                <div class="feature-card">
                    <i class="fas fa-comment-dots"></i>
                    <h3>Feedback</h3>
                    <p>Review and respond to customer feedback.</p>
                    <a href="all_messages.php" class="btn">Go to Feedback</a>
                </div>
            </div>
        </div>
    </section>
